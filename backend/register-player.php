...
if ($idade > 29) {
  echo json_encode(["success" => false, "message" => "Atleta não pode ter mais de 29 anos"]);
  exit;
}
...
// Tenta encontrar clube no mesmo município
...
// Se não houver, procura qualquer clube disponível
if (!$clube) {
